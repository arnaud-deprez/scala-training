...
object Chapter6 extends App {
	...
	// 2
	class UnitConversion(val conversionFactor: Double, val conversionDelta: Double = 0) {
		def convert(units: Double) = conversionFactor * units + conversionDelta
	}
	...
	// I guess this is a way to simulate an App run
